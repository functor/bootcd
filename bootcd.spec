...
ln -sf $RPM_BUILD_ROOT/lib/systemd/system/pl_boot.target /etc/systemd/system/default.target
ln -sf $RPM_BUILD_ROOT/lib/systemd/system/pl_boot.service /lib/systemd/system/pl_boot.target.wants/pl_boot.service
ln -sf $RPM_BUILD_ROOT/lib/systemd/system/pl_sysinit.service /lib/systemd/system/pl_sysinit.target.wants/pl_sysinit.service
popd
